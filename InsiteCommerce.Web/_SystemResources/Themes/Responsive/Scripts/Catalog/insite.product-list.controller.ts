    ...
    export class ProductListController {
        ...
        protected getProductsCompleted(productCollection: ProductCollectionModel, params: IProductCollectionParameters, expand?: string[]): void {
            ...
            if (productCollection.searchTermRedirectUrl) {
                const startsWithProtocol = productCollection.searchTermRedirectUrl.lastIndexOf("http", 0) === 0;
                const locationPath = startsWithProtocol
                ...
                if (locationPath !== productCollection.searchTermRedirectUrl
                    ...
                    if (startsWithProtocol) {
                        ...
                        if (productCollection.searchTermRedirectUrl.indexOf(this.$window.location.pathname) !== -1) {
                            this.coreService.redirectToPathAndRefreshPage(productCollection.searchTermRedirectUrl);
                        } else {
                    ...
                    return;
                } else if (locationPath === productCollection.searchTermRedirectUrl) {
